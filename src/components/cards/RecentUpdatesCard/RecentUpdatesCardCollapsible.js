...
import UniversalCollapsibleCard from '../UniversalCollapsibleCard';

const RecentUpdatesCardCollapsible = ({ 
  currentDate, 
  dataDate, 
  dateStatus, 
  topPerformers, 
  ...
  return (
    <UniversalCollapsibleCard
      cardId="recent-updates"
      title="📊 Recent Updates"
      cardClassName="recent-updates-card"
...
export default RecentUpdatesCardCollapsible;